...
from recpaper_app.api.views import project_view, user_view, project_detail, user_login, user_register, User_projects_view,verify_project
...
urlpatterns = [
    ...
    path('user_projects/<str:pk>/', User_projects_view.as_view(), name='paper_list'),
